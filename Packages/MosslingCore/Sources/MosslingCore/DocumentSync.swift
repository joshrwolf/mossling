...
public struct ConfigurationSnapshot: Codable, Equatable, Sendable {
    ...
    public init(configuration: AppConfiguration, authorityID: UUID) {
        version = 6; self.configuration = configuration; self.authorityID = authorityID
    }
    ...
    public static func decode(_ data: Data) throws -> Self {
        ...
        guard header.version == 6 else { throw SyncProtocolError.unsupportedVersion(header.version) }
