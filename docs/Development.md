...
`BrackenActivities` supplies movement illustrations through `ActivityArtwork.swift`. Poses follow the saved activity movement choice, independent of its editable wording; the editor lets custom activities choose a pose. Check card and session crops, including accessibility text sizes.
